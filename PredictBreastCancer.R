## Project: Predict Breast Cancer
## Author: Ratna Ray
## Date: 6/11/2019"
## GitHub Codebase: https://github.com/RatnaRay/BreastCancer
...
data <- data <- read.csv("https://raw.githubusercontent.com/RatnaRay/BreastCancer/master/BreastCancer.csv")

data$diagnosis <- as.factor(data$diagnosis)


# The 33rd column is incorrect
data[,33] <- NULL
